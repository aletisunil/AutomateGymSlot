...
def Booking():
    ...
    browser = webdriver.Chrome(executable_path=environ["CHROMEDRIVER_PATH"], options=chrome_options)
    ...
    try:
        ...
        browser.find_element_by_xpath('//*[@id="i0116"]').send_keys(environ["Email"])
        browser.find_element_by_xpath('//*[@id="idSIButton9"]').click()
        sleep(2)
        browser.find_element_by_xpath('//*[@id="i0118"]').send_keys(environ["Password"])
        sleep(2)
